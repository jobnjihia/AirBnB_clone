...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, args):
        """
        Prints/shows the string representation of a specific instance
    ...
    def do_destroy(self, args):
        """
        Delete command that deletes an instance
    ...
    def do_all(self, args):
        """
        All command that prints a string representation of all instances
